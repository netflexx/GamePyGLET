...
def activate_puzzle(a):
    if a == 'abc':
        ...
        #sound_effect
        # fail_sound = pyglet.media.load('C:/Users/flip/Documents/game/failsfx.wav',  streaming=False)
        # correct_sound = pyglet.media.load('C:/Users/flip/Documents/game/coolsfx.wav', streaming=False)
        # puzzle_backgroud = pyglet.media.load('C:/Users/flip/Documents/game/puzzle_backgroud.wav', streaming=True)
        ...
        def on_draw():
            ...
            if puzzle.game_stat == 'WIN':
                ...
                #time_label.text = 'TIME LEFT ' + str(10 - puzzle.time)
                #time_label.draw()
